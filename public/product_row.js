    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          "td",
          null,
          React.createElement("input", { "class": "quantity", type: "number" })
        ),
        React.createElement(
          "td",
          { "class": "unity" },
...
var domContainer = document.getElementById('product_row_container');
ReactDOM.render(React.createElement(ProductRow, null), domContainer);